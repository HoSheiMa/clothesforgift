                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class=" btn btn-info" onclick="MessageTo(this)">رسالة دعم</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">
                                        الرسائل
                                        <button class=" btn btn-info d-sm-block d-md-none" onclick="MessageTo(this)">رسالة دعم</لا>
                        ...
                        <!-- end page title -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div  style="max-height: 375px;">

                                                    <a href="javascript:void(0);" onclick="openChat('{{$chat->id}}', '{{($chat->from_user() ? $chat->from_user()->name : 'User')}}', 1, false,'{{($chat->order_id)}}')" class="text-body">
                                                        <div class="d-flex align-items-start p-2">
                                                            <img src="/assets/images/users/user1.png    " class="me-2 rounded-circle" height="42" alt="James Z" />
                                                            <div class="w-100">
                                                                <h5 class="mt-0 mb-0 font-14">
                                                                    {{($chat->from_user() ? $chat->from_user()->name : 'User')}}
                                                                </h5>
                                                                <p class="mt-1 mb-0 text-muted font-14">
                                                                    <span class="badge {{$chat->last_sender == Auth::user()->id ? "badge-outline-success" : 'badge-outline-danger'}}">{{$chat->last_sender == Auth::user()->id ? "read" : 'unread' }}</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </a>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <div class="text-center">
                                                    <h3 class="mt-4">لا توجد رسائل</h3>
                                                    <p class="text-muted mb-0">لا توجد رسائل في الصندوق في الوقت الحالي</p>
                                                </div>
                            ...
                            <!-- chat area -->
                            <div class="col-xl-9 col-lg-8 text-center loading d-none">
                                        ...
                                        <div class="row justify-content-between py-1">
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-start">
                                                    <img src="/assets/images/users/user1.png" class="me-2 rounded-circle" height="36" alt="Brandon Smith">
                                                    <div>
                                                        <h5 class="mt-0 mb-0 font-15">
                                                            <a class="text-reset user-name">James Zavel</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <div id="tooltips-container">
                                                    ...
                                                    <a onclick="deleteChat()" class="text-reset font-19 py-1 px-2 d-inline-block">
                                                    ...
                                                    <form class="needs-validation" novalidate="" name="chat-form" id="chat-form">
                                                        <div class="row">
                                                            <div class="col mb-2 mb-sm-0">
                                                                <textarea id="msg" type="text" class="form-control border-0" placeholder="Enter your text" required="" ></textarea>
                                                            ...
                                                            <div class="col-sm-auto">
                                                                <div class="btn-group">
                                                                    <button type="button" onclick="send()" class="btn btn-success chat-send w-100"><i class="fe-send"></i></button>
                                                                </div>
                                                            </div>
                                                            <!-- end col -->
                                                        </div>
